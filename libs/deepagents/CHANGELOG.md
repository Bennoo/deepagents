...
## [0.5.10](https://github.com/Bennoo/deepagents/compare/deepagents==0.5.9...deepagents==0.5.10) (2026-05-12)


### Features

* **quickjs:** rename middleware ([#3334](https://github.com/Bennoo/deepagents/issues/3334)) ([fc80075](https://github.com/Bennoo/deepagents/commit/fc80075c65c3b4beb8f672b6bb27464fee6d79c2))
...
* **sdk:** add `ContextHubBackend` backend type ([#3338](https://github.com/Bennoo/deepagents/issues/3338)) ([6962826](https://github.com/Bennoo/deepagents/commit/69628263cb2c1f6951b1b37bbc0edbb85983ad51))
...
* **cli:** prevent stdin hang by passing `DEVNULL` ([#2427](https://github.com/Bennoo/deepagents/issues/2427)) ([5bf5fae](https://github.com/Bennoo/deepagents/commit/5bf5fae8d93beba90628f2f71e3e79817a36ac9e))
* **sdk:** add write preflight and native read to langsmith sandbox ([#2695](https://github.com/Bennoo/deepagents/issues/2695)) ([741221c](https://github.com/Bennoo/deepagents/commit/741221c9d8b65a535816e318ee24d3c19a4bde80))
* **sdk:** auto-added GP subagent inherits parent permissions ([#3131](https://github.com/Bennoo/deepagents/issues/3131)) ([0d55b3b](https://github.com/Bennoo/deepagents/commit/0d55b3ba8b974d06b1e0f52893f33e44496bff8b))
* **sdk:** avoid deprecated-use warnings in `CompositeBackend` path mutation ([#3244](https://github.com/Bennoo/deepagents/issues/3244)) ([64d45f6](https://github.com/Bennoo/deepagents/commit/64d45f67c86edb4df2ced0e7b82f1a8fd158ec8c))
...
* **sdk:** harden `FilesystemBackend` against symlink loops ([#3035](https://github.com/Bennoo/deepagents/issues/3035)) ([abd02f9](https://github.com/Bennoo/deepagents/commit/abd02f99ef12030bdfe429fdc3ad80a2785bea61))
...
* **sdk:** import profile symbols directly from `harness_profiles` ([#3291](https://github.com/Bennoo/deepagents/issues/3291)) ([503453c](https://github.com/Bennoo/deepagents/commit/503453c06f7e0545914789a07ddba6ca6b0c8ec5))
...
* **sdk:** propagate `CompiledSubAgent` name into `lc_agent_name` metadata ([#3045](https://github.com/Bennoo/deepagents/issues/3045)) ([f671e6b](https://github.com/Bennoo/deepagents/commit/f671e6b18aa49700a535f7b48441662b67dafef9))
...
* **sdk:** re-export filesystem permission for backwards compatibility ([#3036](https://github.com/Bennoo/deepagents/issues/3036)) ([e04b50a](https://github.com/Bennoo/deepagents/commit/e04b50ae291abefa64ee2750a0c1bbfd93954b32))
...
* **sdk:** surface EOF-newline mismatch in `edit_file` ([#3031](https://github.com/Bennoo/deepagents/issues/3031)) ([d30686e](https://github.com/Bennoo/deepagents/commit/d30686ec82d36a0e9430f7c512c34835aba2c079))
